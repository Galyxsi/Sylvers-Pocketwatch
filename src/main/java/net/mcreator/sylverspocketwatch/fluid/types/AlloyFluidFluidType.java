...
package net.mcreator.sylverspocketwatch.fluid.types;
...
public class AlloyFluidFluidType extends FluidType {
	public AlloyFluidFluidType() {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("sylvers_pocketwatch:block/metalslurdgestill"), FLOWING_TEXTURE = new ResourceLocation("sylvers_pocketwatch:block/metalslurdgemove");
