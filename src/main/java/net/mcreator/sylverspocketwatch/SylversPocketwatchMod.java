 ...
 *
 */
package net.mcreator.sylverspocketwatch;
...
@Mod("sylvers_pocketwatch")
public class SylversPocketwatchMod {
	public static final Logger LOGGER = LogManager.getLogger(SylversPocketwatchMod.class);
	public static final String MODID = "sylvers_pocketwatch";

	public SylversPocketwatchMod() {
